...
function crearFiltroCard(filtro) {
    ...
    if (!contenedor)
        throw new Error("No se encontró el contenedor de filtros");
    ...
    if (!freqSlider)
        throw new Error("No se encontró el slider de frecuencia");
    const freqValue = contenedor.querySelector(".freq-value");
    if (!freqValue)
        throw new Error("No se encontró el valor de frecuencia");
    ...
    if (!qSlider)
        throw new Error("No se encontró el slider de Q");
    const qValue = contenedor.querySelector(".q-value");
    if (!qValue)
        throw new Error("No se encontró el valor de Q");
    ...
    if (!gainSlider)
        throw new Error("No se encontró el slider de gain");
    const gainValue = contenedor.querySelector(".gain-value");
    if (!gainValue)
        throw new Error("No se encontró el valor de gain");
    ...
    if (!bypassCheckbox)
        throw new Error("No se encontró el checkbox de bypass");
    ...
    eliminarBtn.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
        contenedor.remove();
